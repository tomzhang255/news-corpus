...
#SBATCH --job-name=test4-16                # What to show in squeue
...
#SBATCH --time=02:00:00                    # How long to run (hrs:min:sec)
#SBATCH --output=test-log-4-16-%j.txt      # Where to save the output
