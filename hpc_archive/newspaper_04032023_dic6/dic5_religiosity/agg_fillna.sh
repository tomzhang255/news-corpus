...
#SBATCH --job-name=dic5_fillna             # What to show in squeue
...
#SBATCH --mem=999gb                        # How much memory to request
#SBATCH --nodes=1                          # Minimum number of nodes allocated for this job
#SBATCH --cpus-per-task=1                  # Number of cores requested
#SBATCH --time=01-00:00:00                 # How long to run (days-hrs:min:sec)
#SBATCH --output=agg-fillna-%j.txt         # Where to save the output
