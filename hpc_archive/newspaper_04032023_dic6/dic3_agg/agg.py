# aggregating dic3 and dic3-1 populist dicitonary word counting results
...
for file_name in glob.glob("dic3_norm/dic3-"+'*.csv'):
...
df.to_csv('dic3_norm/dic3_agg.csv', index=False)
